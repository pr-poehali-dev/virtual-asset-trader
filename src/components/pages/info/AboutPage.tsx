        ...
        {[
          {
            ...
            items: [
              ...
              "Срок удержания средств: до подтверждения покупателем или 72 часа с момента покупки",
              "Для отдельных категорий (например CS2 скины) администрация устанавливает дополнительный холд после покупки",
