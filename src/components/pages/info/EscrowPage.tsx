    ...
    <div className="max-w-4xl mx-auto px-6 py-10 animate-fade-in">
      ...
      <div className="space-y-4 mb-12">
        {[
          ...
          {
            icon: "Sword",
            title: "CS2 скины — особые условия",
            body: "При продаже скинов CS2 после подтверждения передачи обеими сторонами средства удерживаются дополнительно 8 дней (холд). Это защищает от мошенничества с возвратом предмета через Steam.",
          },
          {
            icon: "AlertTriangle",
